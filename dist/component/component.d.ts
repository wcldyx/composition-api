...
declare type VueProxy<PropsOptions, RawBindings> = Vue2ComponentOptions<
  Vue,
  UnwrapRef<RawBindings>,
  never,
  never,
...
export declare type SetupFunction<Props, RawBindings> = (
  this: void,
  props: Props,
  ctx: SetupContext
...
export declare function defineComponent<RawBindings>(
...
export declare function createComponent<RawBindings>(
  options: ComponentOptionsWithoutProps<unknown, RawBindings>
): VueProxy<unknown, RawBindings>;
